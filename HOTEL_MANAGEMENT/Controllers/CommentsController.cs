...
namespace HOTEL_MANAGEMENT.Controllers
{
    public class CommentsController : Controller
    {
        ...
        {
            var url = "https://localhost:50653/predict";
            ...
            var data = "{\"score\": 0, \"new_reviews\": \"" + comment + "\"}";
            ...
            using (var streamReader = new StreamReader(httpResponse.GetResponseStream()))
            {
                ...
                score = Convert.ToInt32(JObject.Parse(result)["prediction"]);
            }
            return score;
        }
        ...
        public ActionResult Create()
        {
            if (Request.Form["comment"] != null)
            {
                ...
                int result = PredictCommentScore(comment);
                bool sentiment = result >= 0 ? true : false;
